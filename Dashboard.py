...
st.write('There are several subcategories of Radioactive Waste, one of them being the High-Level Waste (HLW), which can have some its origin traced back to Fission Products and Minor Actinides.')
